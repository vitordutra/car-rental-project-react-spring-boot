...
# Configuração para que o MySQL utilize o banco de dados criado
USE dh_carshop;
...
# Imagens
INSERT INTO imagens (titulo, url)
...
# Categorias
INSERT INTO categorias (qualificacao, descricao, id_imagem)
...
# ImagensProdutos
INSERT INTO imagens_produtos (id_produto, id_imagem)
VALUES ();

# Caracteristicas
INSERT INTO caracteristicas (nome, icone)
VALUES ();

# CaracteristicasProdutos
INSERT INTO caracteristicas_produtos (id_produto, id_caracteristica)
VALUES ();
